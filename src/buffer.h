...
#ifndef __pygl_buffer_h_
#define __pygl_buffer_h_
...
struct TypeConvert
{
  ...
  inline static PyObject* ToPy(T)
  {
    PyErr_SetString(PyExc_RuntimeError, "Could not convert type to Python");
    return NULL;
  }
  inline static T FromPy(PyObject *)
  {
    PyErr_SetString(PyExc_RuntimeError, "Could not convert type from Python");
    return T(0);
  }
};
...
template <> struct TypeConvert<DT_BYTE> {
  inline static PyObject* ToPy(char val) {
    return PyInt_FromLong(long(val));
  }
  inline static char FromPy(PyObject *o) {
    return (char)(PyInt_AsLong(o));
  }
};
template <> struct TypeConvert<DT_SHORT> {
  inline static PyObject* ToPy(short val) {
    return PyInt_FromLong(long(val));
  }
  inline static short FromPy(PyObject *o) {
    return (short)(PyInt_AsLong(o));
  }
};
template <> struct TypeConvert<DT_INT> {
  inline static PyObject* ToPy(int val) {
    return PyInt_FromLong(long(val));
  }
  inline static unsigned int FromPy(PyObject *o) {
    return (int)(PyInt_AsLong(o));
  }
};
template <> struct TypeConvert<DT_LONG> {
  inline static PyObject* ToPy(long val) {
    return PyInt_FromLong(long(val));
  }
  inline static unsigned int FromPy(PyObject *o) {
    return (long)(PyInt_AsLong(o));
  }
};
template <> struct TypeConvert<DT_UBYTE> {
  inline static PyObject* ToPy(unsigned char val) {
    return PyInt_FromLong(long(val));
  }
  inline static unsigned char FromPy(PyObject *o) {
    return (unsigned char)(PyInt_AsLong(o));
  }
};
template <> struct TypeConvert<DT_USHORT> {
  inline static PyObject* ToPy(unsigned short val) {
    return PyInt_FromLong(long(val));
  }
  inline static unsigned short FromPy(PyObject *o) {
    return (unsigned short)(PyInt_AsLong(o));
  }
};
template <> struct TypeConvert<DT_UINT> {
  inline static PyObject* ToPy(unsigned int val) {
    return PyInt_FromLong(long(val));
  }
  inline static unsigned int FromPy(PyObject *o) {
    return (unsigned int)(PyInt_AsLong(o));
  }
};
template <> struct TypeConvert<DT_ULONG> {
  inline static PyObject* ToPy(unsigned long val) {
    return PyInt_FromLong(long(val));
  }
  inline static unsigned long FromPy(PyObject *o) {
    return (unsigned long)(PyInt_AsLong(o));
  }
};
template <> struct TypeConvert<DT_FLOAT> {
  inline static PyObject* ToPy(float val) {
    return PyFloat_FromDouble(double(val));
  }
  inline static float FromPy(PyObject *o) {
    return (float)(PyFloat_AsDouble(o));
  }
};
template <> struct TypeConvert<DT_DOUBLE> {
  inline static PyObject* ToPy(double val) {
    return PyFloat_FromDouble(double(val));
  }
  inline static double FromPy(PyObject *o) {
